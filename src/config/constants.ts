...
export const CHARACTERS: CharacterConfig[] = [
  ...
  { id: 'Knight', name: 'Knight', rarity: 'Legendary', costCoins: 10000, costDiamonds: 100, modelPath: '/assets/runner/runner/characters/Knight.fbx', scaleOverride: 1.12, yOffset: 0.65 },
];
